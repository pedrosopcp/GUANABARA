...
map.getView().fit([-4853204.586238, -2648203.322424, -4732461.420335, -2547688.070560], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">RH V - Baía de Guanabara</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (112 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Definição de trechos prioritários com vistas à elaboração de futura proposta de enquadramento de corpos hídricos';
            }
